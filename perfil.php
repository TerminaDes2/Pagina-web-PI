                    ...
                    <table class="tabla-contenido">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $pub['fecha'] ?></td>
                                <td class="acciones">
                                    <a href="php/publicacion.php?id=<?= $pub['id_entrada'] ?>" class="btn-accion ver">
                                        <i class="fas fa-eye"></i> <?= $translator->__("Ver") ?>
                                    </a>
                                    <?php if ($_SESSION['usuario']['perfil'] === 'admin'): ?>
                                    <a href="php/editar_publicacion.php?id=<?= $pub['id_entrada'] ?>" class="btn-accion editar">
                    ...
                    <table class="tabla-contenido">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $com['fecha'] ?></td>
                                <td class="acciones">
                                    <a href="php/publicacion.php?id=<?= $com['id_entrada'] ?>#comentario-<?= $com['id_comentario'] ?>" class="btn-accion ver">
                                        <i class="fas fa-eye"></i> <?= $translator->__("Ver") ?>
                                    </a>
                                </td>
                            </tr>
